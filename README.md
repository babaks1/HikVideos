...
**[⬇️ Télécharger HikVideos](../../releases/latest)** — prenez le fichier qui
se termine par `.deb`, puis double-cliquez dessus.

C'est tout : rien d'autre à installer, HikVideos apparaît dans votre menu.
Pour Ubuntu, Debian et dérivés, en 64 bits.
