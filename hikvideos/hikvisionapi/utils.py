...
def getXMLRaw(server: hikvisionapi.HikvisionServer, path: str, xmldata: str = None, rawResponse: bool = False) -> dict:
    ...
    # rawResponse sert au téléchargement des vidéos : sans stream=True,
    # requests charge tout le fichier en mémoire avant de rendre la main,
    # et l'appelant ne peut plus suivre l'avancement — la progression
    # saute d'un coup à la fin de chaque fichier.
    if xmldata is None:
