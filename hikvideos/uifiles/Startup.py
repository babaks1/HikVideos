...
class Ui_Startup(object):
    def setupUi(self, Startup):
        ...
        self.video_format.addItem("")
        self.video_format.addItem("")
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.video_format)
        ...
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.start_date)
        ...
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.end_date)
        ...
        Startup.setTabOrder(self.folder_behavior, self.video_format)
    ...
    def retranslateUi(self, Startup):
        ...
        Startup.setWindowTitle(_translate("Startup", "HikVideos"))
        self.label.setText(_translate("Startup", "Adresse IP de la caméra"))
        self.label_2.setText(_translate("Startup", "Identifiant"))
        self.label_6.setText(_translate("Startup", "Dossier de téléchargement des vidéos"))
        self.label_3.setText(_translate("Startup", "Mot de passe"))
        self.downloads_folder_button.setText(_translate("Startup", "..."))
        self.label_4.setText(_translate("Startup", "Classement des vidéos"))
        self.folder_behavior.setCurrentText(_translate("Startup", "Tout dans le même dossier"))
        self.folder_behavior.setItemText(0, _translate("Startup", "Tout dans le même dossier"))
        self.folder_behavior.setItemText(1, _translate("Startup", "Un dossier par caméra"))
        self.folder_behavior.setItemText(2, _translate("Startup", "Un dossier par jour"))
        self.folder_behavior.setItemText(3, _translate("Startup", "Un dossier par mois"))
        self.folder_behavior.setItemText(4, _translate("Startup", "Un dossier par an"))
        self.label_5.setText(_translate("Startup", "Format vidéo"))
